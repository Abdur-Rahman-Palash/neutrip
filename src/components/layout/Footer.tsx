          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3">
                 ...
                 <span>+880 9617-617-617<br/><span className="text-gray-500 text-xs">24/7 Support</span></span>
              </li>
              <li className="flex items-start gap-3">
              ...
              <li className="flex items-start gap-3">
                 ...
                 <span>Rangs Pearl Tower, 4th Floor,<br/>House 76, Road 12, Block E,<br/>Banani, Dhaka 1213</span>
              </li>
            </ul>
          </div>
        </div>
